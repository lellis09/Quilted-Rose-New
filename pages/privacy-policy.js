        ...
        <main className="flex flex-col items-center relative">
            <div className="absolute inset-0 z-[-1] background">
                ...
                >
                    ...
                    />
                    <p className="text-[18px] w-1/2 text-center pb-6">In those rare instances where it is necessary for Dr. Walker to disclose information relating to your counseling without your permission, Dr. Walker will make every effort to fully discuss it with you. However, when Dr. Walker is required to disclose your records pursuant to a court order issued under the Patriot Act, I may be prohibited by the terms of the order from notifying you of the disclosure.</p>
                    <p className="text-[18px] w-1/2 text-center">There are two other instances where Dr. Walker, the therapist, may also be released from the confidentiality rule. One is if there is a charge brought against me to the licensing board or in court, I am allowed to use all information to defend themselves. The second is if a patient does not pay the bill for therapy, after reasonable efforts at collections Dr. Walker is allowed to involve legitimate collections activity by other parties, which will release information such as dates of service, charges, payments and balances necessary for the collections process.</p>
                </Column1>
                <Column1 
                    className="reads-title text-[18px] "
